...
import { selectcheckouts, STORECHECKOUTS } from '../redux/checkoutSlice'
...
const CheckoutPage = () => {
    ...
    const handleCheckout = (e)=>{
        ...
        if(!name || !mobile || !address1 || !city || !pincode){
            ...
            dispatch(STORECHECKOUTS(shippingAddress))
            navigate('/checkoutpayment')
        }  
    }
    const checkoutAddress = useSelector(selectcheckouts)
    useEffect(()=>{
