...
const AOrderDetails = () => {
  ...
  return (
    <div className="container mx-auto shadow-lg  p-6 bg-white rounded-lg">
    <h1 className="text-2xl font-bold mb-4">My Order Details</h1>
    <hr className="mb-4" />
    <div className="mb-3 w-50">
        <Link to='/admin/orders' className='flex items-center gap-2 bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 transition'>
    ...
    {order == null ? (
        ...
        <>
            <>
                ...
                <ChangeOrderStatus status={order.status} order={order}/>}
               </>
            <div className='mt-4'>
